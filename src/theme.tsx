...
export const customTheme = createTheme({
  ...
  modal: {
    "root": {
      ...
      "show": {
        "on": "flex bg-gray-100/50 dark:bg-black/50 transition-all duration-500 transform",
        "off": "hidden"
      },
      "sizes": {
        "sm": "max-w-sm",
    ...
    "content": {
      ...
      "inner": "transition-all duration-600 transform relative flex max-h-[90dvh] flex-col rounded-2xl bg-white/50 dark:bg-gray-800/50 shadow-md backdrop-blur-2xl border border-white/30 dark:border-gray-700/30",
    },
    "body": {
